...
class WebApiTemplateService {
    ...
    private static func createDesignPhase() -> PhaseTemplate {
        PhaseTemplate(
            ...
            taskLists: [
                createApiDesignTaskList(),
                createDataModelTaskList()
            ]
        )
    }
    ...
    private static func createDevelopmentPhase() -> PhaseTemplate {
        PhaseTemplate(
            ...
            taskLists: [
                createServerImplementationTaskList(),
                createDatabaseTaskList(),
                createAuthenticationTaskList()
            ]
        )
    }
    ...
    private static func createTestingPhase() -> PhaseTemplate {
        PhaseTemplate(
            ...
            estimatedDuration: "2-3週間",
            taskLists: [
                createApiTestingTaskList(),
                createSecurityTestTaskList()
            ]
        )
    }
    ...
    private static func createApiDesignTaskList() -> TaskListTemplate {
        TaskListTemplate(
            name: "設計",
            color: .blue,
            order: 0,
    ...
    private static func createDataModelTaskList() -> TaskListTemplate {
        TaskListTemplate(
            name: "データモデル",
            color: .purple,
            order: 1,
    ...
    private static func createServerImplementationTaskList() -> TaskListTemplate {
        TaskListTemplate(
            name: "サーバー実装",
            color: .green,
            order: 0,
    ...
    private static func createDatabaseTaskList() -> TaskListTemplate {
        TaskListTemplate(
            name: "データベース",
            color: .orange,
            order: 1,
    ...
    private static func createAuthenticationTaskList() -> TaskListTemplate {
        TaskListTemplate(
            name: "認証・認可",
            color: .red,
            order: 2,
    ...
    private static func createApiTestingTaskList() -> TaskListTemplate {
        TaskListTemplate(
            name: "APIテスト",
            color: .yellow,
            order: 0,
    ...
    private static func createSecurityTestTaskList() -> TaskListTemplate {
        TaskListTemplate(
            name: "セキュリティテスト",
            color: .red,
            order: 1,
    ...
    private static func createMonitoringTaskList() -> TaskListTemplate {
        TaskListTemplate(
            name: "監視・ログ",
            color: .purple,
            order: 1,
